...
import com.dicoding.picodiploma.mysubmission.databinding.ActivityDetailBinding
import com.dicoding.picodiploma.mysubmission.detail.follow.FollowsAdapter
import com.google.android.material.tabs.TabLayoutMediator

class DetailActivity : AppCompatActivity() {

    private lateinit var binding: ActivityDetailBinding
    private val viewModel: DetailViewModel by this.viewModels()
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val followsAdapter = FollowsAdapter(this, uname.orEmpty())
        binding.apply {
